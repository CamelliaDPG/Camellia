...
=======
positive-definite DPG system into a saddle-point problem.
>>>>>>> c0555dd502009489de326e7d9ed795c6513bc4ae
\end{abstract}
...
used to try to address this. Bochev \etal\cite{Bochev2010} accomplish local
conservation by using a point-wise divergence free velocity space in the Stokes
=======
...
<<<<<<< HEAD
falls under the purview of the Lax-Wendroff theorem.
=======
