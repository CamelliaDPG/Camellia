...
\[
\vecttwo{u}{1}\cdot\Grad_{xt}u=0\,.
\]
Multiplying by a test function $v$, and integrating by parts:
\[
-\LRp{\vecttwo{u}{1}u,\Grad_{xt}v}+\LRa{\hat t,v}=\LRp{f,v}\,,
\]
where $\hat t$ is the trace of $\vecttwo{u^2}{u}\cdot\mathbf{n}_{xt}$ on
...
until the solution converges. The results follow in Section \ref{sec:inviscidBurgers}.
...
live in $L^2$. We can, however, integrate the flux over element boundaries.
...
\centering
\includegraphics[width=\textwidth]{figs/StokesCylinder/umag9_NC0.png}
\caption{Nonconservative on initial mesh}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{figs/StokesCylinder/umag9_C0.png}
\caption{Conservative on initial mesh}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{figs/StokesCylinder/umag9_NC6.png}
\caption{Nonconservative after 6 refinement steps}
\label{fig:stokesCylinderNC}
\end{subfigure}
\begin{subfigure}[t]{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{figs/StokesCylinder/umag9_C6.png}
\caption{Conservative after 6 refinement steps}
\label{fig:stokesCylinderC}
\end{subfigure}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth]{figs/StokesCylinder/MassLoss9_NC.pdf}
\caption{Mass loss in Stokes flow around a cylinder - nonconservative DPG}
\label{fig:stokesCylinderMassLossNC}
\end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth]{figs/StokesCylinder/MassLoss9_C.pdf}
\caption{Mass loss in Stokes flow around a cylinder - conservative DPG}
\label{fig:stokesCylinderMassLossC}
\end{figure}
...
\]
and zero velocity on all other boundaries.
...
\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth]{figs/StokesStep/MassLoss_NC.pdf}
\caption{Mass loss in Stokes backward facing step - nonconservative DPG}
\label{fig:stokesStepMassLossNC}
\end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth]{figs/StokesStep/MassLoss_C.pdf}
\caption{Mass loss in Stokes backward facing step - conservative DPG}
