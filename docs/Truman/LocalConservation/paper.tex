...
\includegraphics[width=0.45\textwidth]{figs/Erickson/graphError.pdf}
\caption{Error in Erickson-Johnson solution with graph norm}
\label{fig:ericksonGraphError}
}\quad
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Erickson/robustError.pdf}
\caption{Error in Erickson-Johnson solution with robust norm}
...
\centering
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Erickson/graphFlux.pdf}
\caption{Flux imbalance in Erickson-Johnson solutions with graph norm}
\label{fig:ericksonGraphFlux}
}\quad
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Erickson/robustFlux.pdf}
\caption{Flux imbalance in Erickson-Johnson solutions with robust norm}
...
\centering
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/graph0c.png}
\caption{Conservative skewed convection-diffusion with graph norm, initial mesh}
\label{fig:confusionGraph0c}
}\quad
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/robust0c.png}
\caption{Conservative skewed convection-diffusion with robust norm, initial mesh}
...
% \centering
% \parbox{0.45\textwidth}{
% \includegraphics[width=0.45\textwidth]{figs/Confusion/graph8nc.png}
% \caption{Nonconservative skewed convection-diffusion with graph norm, after 8
% refinements}
% \label{fig:confusionGraph8nc}
% }\quad
% \parbox{0.45\textwidth}{
% \includegraphics[width=0.45\textwidth]{figs/Confusion/robust8nc.png}
% \caption{Nonconservative skewed convection-diffusion with robust norm, after 8
% refinements}
% \label{fig:confusionRobust8nc}
% }
% \end{figure}
...
\centering
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/graph8c.png}
\caption{Conservative skewed convection-diffusion with graph norm, after 8
refinements}
\label{fig:confusionGraph8c}
}\quad
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/robust8c.png}
\caption{Conservative skewed convection-diffusion with robust norm, after 8
refinements}
...
\centering
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/graphFlux.pdf}
\caption{Flux imbalance in skewed confusion solutions with graph norm}
\label{fig:confusionGraphFlux}
}\quad
\parbox{0.45\textwidth}{
\includegraphics[width=0.45\textwidth]{figs/Confusion/robustFlux.pdf}
\caption{Flux imbalance in skewed confusion solutions with robust norm}
