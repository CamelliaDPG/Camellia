...
\subsection{\textcolor{red}{Make new subsection on robustness here, reorganize}}
...
\]
The choice of test norm \textcolor{red}{should be explained here}. 
...
\textcolor{Fix ordering of lemmas} The second lemma concerns the robust control of $u$ by the energy error; the first and third concern the robust control of field variable $\sigma$ and flux/trace variables, respectively.  
