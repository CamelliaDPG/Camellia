...
We've shown the robust bound of a norm on $U$ by energy error; for a full equivalence statement between the energy norm and norms on $U$, we require a bound on the energy norm by some norm on $U$. 
