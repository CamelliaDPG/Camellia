...
\end{align*}
where $n$ is the outward normal vector to an element edge, and ${\rm sgn}(n)$ is 1 if $n$ aligns with a given global orientation, and $-1$ otherwise. \textcolor{red}{I need to find more simple way to explain sgn}.
