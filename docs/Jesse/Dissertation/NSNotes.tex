...
\begin{figure}
\centering
\subfigure[$dt = .1$]{\includegraphics[scale=.35]{figs/confusionDtFigs/dt10.png}}
\subfigure[$dt = .01$]{\includegraphics[scale=.35]{figs/confusionDtFigs/dt100.png}}
...
\end{align*}
where $\nor{\LRp{\tau,v}}_{V}$ is the coupled test norm introduced in Section~\secref{sec:testNormSec}, and $b(u,v)$ and $l(v)$ are the bilinear form and load for the steady state form of the convection diffusion equation.  DPG solutions minimize the functional 
\[
...
\begin{figure}
\centering
\subfigure[$T$]{\includegraphics[scale=.3]{figs/propMovie/T0.png}}
\subfigure[$u_1$]{\includegraphics[scale=.3]{figs/propMovie/u0.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/rho.png}}
\subfigure[$u_1$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/u1.png}}
\subfigure[$u_2$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/u2.png}}
\subfigure[$T$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/T.png}}
\caption{Solutions after twelve refinements for $p=2$ and $\Reyn = 1000$, starting from a mesh of 2 elements.}
\label{fig:Re1000}
\end{figure}

Figure~\ref{fig:Re1000_midRefs} shows snapshots of the third and sixth steps of adaptive mesh refinement.  The main contribution to energy error is at the plate tip -- due to the change in boundary condition across the point $(.5,0)$, the viscous stresses are singular at this point (this is analogous to the convection-diffusion plate example given in Section~\secref{sec:confusionPlate}).  Underresolution of the stresses at this point results in some pollution effects slightly upstream of the beginning of the plate; however, once $h\approx {\rm Re}^{-1}$ near the plate edge, these pollution effects disappear.  We observe numerically that decreasing $dt$ also limits how far upstream of the plate edge this pollution effect travels.

\begin{figure}
\centering
\subfigure[Mesh, 4th refinement]{\includegraphics[width=2.85in]{figs/FlowFigs/PlateFigFiles/Re3/mesh4.png}}
\subfigure[$T$, 4th refinement]{\includegraphics[width=2.85in]{figs/FlowFigs/PlateFigFiles/Re3/T4.png}}
\subfigure[Mesh, 8th refinement]{\includegraphics[width=2.85in]{figs/FlowFigs/PlateFigFiles/Re3/mesh8.png}}
\subfigure[$T$, 8th refinement]{\includegraphics[width=2.85in]{figs/FlowFigs/PlateFigFiles/Re3/T8.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/rhoRescaled.png}}
\subfigure[Mesh]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re3/mesh12.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[scale=.23]{figs/FlowFigs/PlateFigFiles/Re3/rhoZoom.png}}
\subfigure[$u_1$]{\includegraphics[scale=.23]{figs/FlowFigs/PlateFigFiles/Re3/u1Zoom.png}}
\subfigure[$u_2$]{\includegraphics[scale=.23]{figs/FlowFigs/PlateFigFiles/Re3/u2Zoom.png}}
\subfigure[$T$]{\includegraphics[scale=.23]{figs/FlowFigs/PlateFigFiles/Re3/TZoom.png}}
...
\begin{figure}
\centering
\subfigure[Non-convergence]{\includegraphics[width=2.5in]{figs/FlowFigs/PlateFigFiles/oscillations1.eps}}
\subfigure[Recovery of convergence]{\includegraphics[width=2.5in]{figs/FlowFigs/PlateFigFiles/oscillations2.eps}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/rho.png}}
\subfigure[$u_1$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/u1.png}}
\subfigure[$u_2$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/u2.png}}
\subfigure[$T$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/T.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/rhoRescaled.png}}
\subfigure[Mesh]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/mesh.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/rhoZoom.png}}
\subfigure[$u_1$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/u1Zoom.png}}
\subfigure[$u_2$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/u2Zoom.png}}
\subfigure[$T$]{\includegraphics[width=2.8in]{figs/FlowFigs/PlateFigFiles/Re4/TZoom.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$ rescaled]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/rhoRescaled.png}}
\subfigure[$u_1$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/u1.png}}
\subfigure[$u_2$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/u2.png}}
\subfigure[$T$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/T.png}}
\subfigure[Mesh after 24 refinements]{\includegraphics[width = 5.5in]{figs/FlowFigs/RampFigFiles/Ma6Re4/mesh.png}}
...
\begin{figure}
\centering
\subfigure[Initial mesh]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/mesh0.png}}
\subfigure[6 refinements]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/mesh6.png}}
\subfigure[12 refinements]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/mesh12.png}}
\subfigure[18 refinements]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/mesh18.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$ rescaled]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/rhoRescaledshock.png}}
\subfigure[$T$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/Tshock.png}}
\subfigure[Mesh]{\includegraphics[width = 4in]{figs/FlowFigs/RampFigFiles/Ma6Re4/shockMesh.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$ rescaled]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/rhoRescaled.png}}
\subfigure[$u_1$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/u1.png}}
\subfigure[$u_2$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/u2.png}}
\subfigure[$T$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/T.png}}
\subfigure[Mesh]{\includegraphics[width = 5.5in]{figs/FlowFigs/RampFigFiles/Ma11Re4/mesh.png}}
...
%\begin{figure}[!h]
%\centering
%%\subfigure[$\rho$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/rhoshock.png}}
%%\subfigure[$T$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/Tshock.png}}
%\subfigure[Mach 6]{\includegraphics[width = 2.75in]{figs/FlowFigs/RampFigFiles/Ma6Re4/plateMesh.png}}
%\subfigure[Mach 11]{\includegraphics[width = 2.75in]{figs/FlowFigs/RampFigFiles/Ma11Re4/plateMesh.png}}
...
\begin{figure}
\centering
\subfigure[$\rho$ rescaled]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/rhoshock.png}}
\subfigure[$T$]{\includegraphics[width = 2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/Tshock.png}}
\subfigure[Mesh]{\includegraphics[width = 4in]{figs/FlowFigs/RampFigFiles/Ma11Re4/shockMesh.png}}
\caption{Zoom of solutions and adaptive mesh around shock. }
...
The heat flux develops a strong singularity at the point $(-.5,0)$, where the boundary condition changes from a Neumann/stress boundary condition to a Dirichlet/no-slip boundary condition.\footnote{Figure~\ref{fig:heatFlux} cuts off this singularity in order to show the qualitative behavior of $q_n$ over the remainder of the boundary.  The maximum visualized values in the singular portion of $q_n$ are .35 for Mach 6 flow and 1.268 for Mach 11.68 flow.}  Section~\secref{sec:confusionPlate} proves that the Laplace equation develops a singularity in stress at under any such change in boundary conditions, and the same phenomena is observed for a similar setup under the convection-diffusion equation (see also \cite{localConservationDPG}).  

\begin{figure}
\centering
\subfigure[Mach 6, Reynolds 10,000]{\includegraphics[width=2.9in]{figs/FlowFigs/RampFigFiles/Ma6Re4/heatFlux.png}}
\subfigure[Mach 11.68, Reynolds 16,442.4]{\includegraphics[width=2.9in]{figs/FlowFigs/RampFigFiles/Ma11Re4/heatFlux.png}}
...
\begin{figure}
\centering
\subfigure[$u(x)$]{\includegraphics[width = 1.8in]{figs/Burgers1DPlots/u.eps}}
\subfigure[$u'(x)$]{\includegraphics[width = 1.8in]{figs/Burgers1DPlots/du.eps}}
\subfigure[$u''(x)$]{\includegraphics[width = 1.8in]{figs/Burgers1DPlots/ddu.eps}}
...
\begin{figure}
\centering
\subfigure[$\epsilon = .01$]{\includegraphics[width = 2.75in]{figs/Burgers1DPlots/residual100.eps}}
\subfigure[$\epsilon = .001$]{\includegraphics[width = 2.75in]{figs/Burgers1DPlots/residual1000.eps}}
