...
\title{A DPG method for convection-diffusion problems} % Required
...
\previousdegrees{B.A.; M.S.C.S.E.M.}
...
\seclab{chap:problemRange}
\input{problemRange}

\chapter{Discontinuous Petrov-Galerkin: a minimum residual method for linear problems}
\seclab{chap:introDPG}
\input{DPGtheory}

\chapter{The graph norm for convection-diffusion}
\seclab{chap:graphNorm}
\input{confusionDPGIntro}
\input{globalLocalDPG}

\chapter{A robust DPG method for convection-diffusion}
\seclab{chap:robustDPG}
\input{DPGrobustness}
\input{coupledRobust}

\chapter{Extension to nonlinear problems and systems of equations}
\seclab{chap:nonlinDPG}
\input{NonlinDPG}
\input{BurgersNotes}
\input{NSNotes}

\chapter{Conclusions and future direction}
\input{Conclusions}

\bibliographystyle{unsrt}
\bibliography{NSNotes,paper,DPGarticles}

%\chapter{Appendix}
\appendix
\input{paper_appendix.tex}
\input{confusionAppendix.tex}
%\input{hyperbolicDPG.tex}
