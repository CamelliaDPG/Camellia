...
\begin{figure}[!h]
\centering
\subfigure[$\rho$]{\includegraphics[scale=.42]{figs/rho.pdf}}
\subfigure[$u_1$]{\includegraphics[scale=.42]{figs/u1.pdf}}
\subfigure[$u_2$]{\includegraphics[scale=.42]{figs/u2.pdf}}
\subfigure[$T$]{\includegraphics[scale=.42]{figs/T.pdf}}
\caption{Solutions after six refinements for $\Reyn = 1000$.}
\label{fig:Re500}
\end{figure}

\begin{figure}[!h]
\centering
\subfigure[$\rho$]{\includegraphics[scale=.4]{figs/rhozoom.pdf}}
\subfigure[$u_1$]{\includegraphics[scale=.4]{figs/u1zoom.pdf}}
\subfigure[$u_2$]{\includegraphics[scale=.4]{figs/u2zoom.pdf}}
\subfigure[$T$]{\includegraphics[scale=.4]{figs/Tzoom.pdf}}
\caption{Zoom of solutions at the beginning of the plate for $\Reyn = 1000$.}
\label{fig:Re500}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[scale=.75]{figs/mesh.pdf}
\caption{Adaptive mesh after six refinements for $\Reyn = 1000$.}
\label{fig:MeshRe500}
\end{figure}
