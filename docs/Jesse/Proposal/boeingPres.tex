...
\end{figure}
Locally conservative version of DPG performs very similarly to the standard DPG in all cases.
}
...
\caption{Convection-diffusion solution to the Hemker problem.}
\end{figure}
}
\frame{
