...
\title[A DPG method for Compressible Flow]{Application of a Discontinuous Petrov-Galerkin method to compressible flow problems}
\date{Sept 12, 2012}
...
\right. ,
\quad
\LRa{\jump{\tau\cdot n}, \widehat{u} }_{\Gamma}, \LRa{ \widehat{f}_n,\jump{v} }_{\Gamma} = 0
\end{align*}
...
%\end{align*}
Experiments done using Camellia\footnote{\bibentry{Camellia}} and a boundary layer solution.
%\begin{figure}
%\centering
%\subfigure{
