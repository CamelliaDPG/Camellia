...
\begin{figure}[!h]
\centering
\subfigure{\includegraphics[scale=.22]{figs/mesh1.png}}
\subfigure{\includegraphics[scale=.22]{figs/sol1.png}}
...
\begin{figure}
\centering
\subfigure[Primal problem, Dirichlet inflow BC]{\includegraphics[scale=.375]{figs/primalDir.eps}}
\subfigure[Adjoint problem, Dirichlet inflow BC]{\includegraphics[scale=.375]{figs/adjointDir.eps}}
\subfigure[Primal problem, new inflow BC]{\includegraphics[scale=.375]{figs/primal.eps}}
\subfigure[Adjoint problem, new inflow BC]{\includegraphics[scale=.375]{figs/adjoint.eps}}
...
\centering
\subfigure{
\includegraphics[scale=.38]{figs/errorrates_wallBC.eps}
}
\subfigure{
\includegraphics[scale=.38]{figs/L2energyratio_wallBC.eps}
}
...
\centering
\subfigure{
\includegraphics[scale=.38]{figs/roundoff_rates.eps}
}
\subfigure{
\includegraphics[scale=.38]{figs/roundoff_ratio.eps}
}
...
\centering
\subfigure{
\includegraphics[scale=.38]{figs/rates_noSigma.eps}
}
\subfigure{
\includegraphics[scale=.38]{figs/ratio_noSigma.eps}
}
...
\centering
\subfigure{
\includegraphics[scale=.38]{figs/rates_disc.eps}
}
\subfigure{
\includegraphics[scale=.38]{figs/ratio_disc.eps}
}
