...
\title[DPG methods for convective-diffusive problems]{Discontinuous Petrov-Galerkin methods for transport (and convection-diffusion problems)}
...
\end{itemize}
\item Mixed success and lessons with pure convection/Euler.
\end{enumerate}
\end{column}
