...
\begin{figure}[h!]
\centering
\subfigure[Local stiffness computation]{\label{fig:strongScalingLocalStiffnessHSFC}
\includegraphics[scale = \twoFig]{figs/scalingFigs/hsfcStrongScalingLocal.pdf}
}
\subfigure[Global stiffness assembly]{\label{fig:strongScalingAssemblyHSFC}
\includegraphics[scale = \twoFig]{figs/scalingFigs/hsfcStrongScalingAssembly.pdf}
}
\caption{Strong scaling statistics for a HSFC (contiguous) partitioning of the mesh.}
\end{figure}

\begin{figure}[h!]
\centering
\subfigure[Local stiffness computation]{\label{fig:strongScalingLocalStiffnessCyclic}
\includegraphics[scale = \twoFig]{figs/scalingFigs/cyclicStrongScalingLocal.pdf}
}
\subfigure[Global stiffness assembly]{\label{fig:strongScalingAssemblyCyclic}
\includegraphics[scale = \twoFig]{figs/scalingFigs/cyclicStrongScalingAssembly.pdf}
}
\caption{Strong scaling statistics for a cyclic (discontiguous) partitioning of the mesh.}
\end{figure}
