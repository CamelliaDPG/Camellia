...
public:
  ...
  OldroydBFormulation(MeshTopologyPtr meshTopology, Teuchos::ParameterList &parameters);
  ...
  static OldroydBFormulation steadyFormulation(int spaceDim, double Re, bool useConformingTraces,
                                                      MeshTopologyPtr meshTopo, int polyOrder, int delta_k);
  // static OldroydBFormulation spaceTimeFormulation(int spaceDim, double Re, bool useConformingTraces,
  //                                                        MeshTopologyPtr meshTopo, int spatialPolyOrder, int temporalPolyOrder, int delta_k);
  // static OldroydBFormulation steadyConservationFormulation(int spaceDim, double Re, bool useConformingTraces,
  //                                                     MeshTopologyPtr meshTopo, int polyOrder, int delta_k);
  // static OldroydBFormulation spaceTimeConservationFormulation(int spaceDim, double Re, bool useConformingTraces,
  //                                                        MeshTopologyPtr meshTopo, int spatialPolyOrder, int temporalPolyOrder, int delta_k);
  // static OldroydBFormulation timeSteppingFormulation(int spaceDim, double Re, bool useConformingTraces,
  //                                                           MeshTopologyPtr meshTopo, int polyOrder, int delta_k,
