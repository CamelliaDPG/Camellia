...
namespace Camellia {
	class PeriodicBC {
	  ...
	  FunctionPtr<double> _transform0to1, _transform1to0;
	public:
	  PeriodicBC(SpatialFilterPtr pointFilter0, SpatialFilterPtr pointFilter1, FunctionPtr<double> transform0to1, FunctionPtr<double> transform1to0);
	  ...
	  static Teuchos::RCP<PeriodicBC> periodicBC(SpatialFilterPtr pointFilter1, SpatialFilterPtr pointFilter2, FunctionPtr<double> transform1to2, FunctionPtr<double> transform2to1);
