...
namespace Camellia {
  ...
  void LobattoHGRAD_LineBasis<Scalar,ArrayScalar>::initializeL2normValues() {
  ...
  template<class Scalar, class ArrayScalar>
  LobattoHGRAD_LineBasis<Scalar,ArrayScalar>::LobattoHGRAD_LineBasis(int degree, bool conforming) {
    _degree = degree;
  ...
  template<class Scalar, class ArrayScalar>
  void LobattoHGRAD_LineBasis<Scalar,ArrayScalar>::initializeTags() const {
    if (!_conforming) {
  ...
  template<class Scalar, class ArrayScalar>
  void LobattoHGRAD_LineBasis<Scalar,ArrayScalar>::getValues(ArrayScalar &values, const ArrayScalar &refPoints, Intrepid::EOperator operatorType) const {
...
//          cout << "scaling factor squared for " << i << " " << j << ": " << scalingFactor << endl;
  ...
  template<class Scalar, class ArrayScalar>
  bool LobattoHGRAD_LineBasis<Scalar,ArrayScalar>::isConforming() const {
    return _conforming;
  }
} // namespace Camellia