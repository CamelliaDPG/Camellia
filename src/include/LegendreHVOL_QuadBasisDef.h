...
template<class Scalar, class ArrayScalar>
void LegendreHVOL_QuadBasis<Scalar,ArrayScalar>::initializeL2normValues()
{
...
template<class Scalar, class ArrayScalar>
LegendreHVOL_QuadBasis<Scalar,ArrayScalar>::LegendreHVOL_QuadBasis(int degree, bool conforming)
{
  _degree_x = degree;
  _degree_y = degree;
...
template<class Scalar, class ArrayScalar>
LegendreHVOL_QuadBasis<Scalar,ArrayScalar>::LegendreHVOL_QuadBasis(int degree_x, int degree_y, bool conforming)
{
...
template<class Scalar, class ArrayScalar>
void LegendreHVOL_QuadBasis<Scalar,ArrayScalar>::initializeTags() const
{
  if (!_conforming)
  {
...
template<class Scalar, class ArrayScalar>
void LegendreHVOL_QuadBasis<Scalar,ArrayScalar>::getValues(ArrayScalar &values, const ArrayScalar &refPoints, Intrepid::EOperator operatorType) const
{
