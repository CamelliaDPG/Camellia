...
#ifndef Camellia_InviscidBurgersFormulation_h
#define Camellia_InviscidBurgersFormulation_h
...
namespace Camellia
{
class InviscidBurgersFormulation
{
...
public:
  InviscidBurgersFormulation(MeshTopologyPtr meshTopo, Teuchos::ParameterList &parameters);
  ...
  // ! implementation, assumes that the constructor arguments provided to InviscidBurgersFormulation were the same
  // ! on the InviscidBurgersFormulation on which save() was invoked as they were for this InviscidBurgersFormulation.
