...
class SliceFunction : public Function {
  ...
  double _t;
public:
  SliceFunction(MeshPtr spaceTimeMesh, map<GlobalIndexType, GlobalIndexType> &cellIDMap, FunctionPtr spaceTimeFunction, double t) : Function(spaceTimeFunction->rank()) {
