...
void GlobalDofAssignment::projectParentCoefficientsOntoUnsetChildren() {
  ...
  for (vector< SolutionPtr<double> >::iterator solutionIt = _registeredSolutions.begin();
       solutionIt != _registeredSolutions.end(); solutionIt++) {
    SolutionPtr<double> soln = *solutionIt;
...
vector<SolutionPtr<double>> GlobalDofAssignment::getRegisteredSolutions() {
  return _registeredSolutions;
}

void GlobalDofAssignment::registerSolution(SolutionPtr<double> solution) {
...
void GlobalDofAssignment::unregisterSolution(SolutionPtr<double> solution) {
  for (vector< SolutionPtr<double> >::iterator solnIt = _registeredSolutions.begin();
