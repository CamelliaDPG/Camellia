...
class BurgersInnerProduct : public DPGInnerProduct {
 ...
 BurgersInnerProduct(Teuchos::RCP< BurgersBilinearForm > bfs, Teuchos::RCP<Mesh> mesh) : DPGInnerProduct((Teuchos::RCP< BurgersBilinearForm>) bfs) {
  ...
  double getWeight(double x,double y){
    ...
    return _burgersBilinearForm->getEpsilon() + x*x*y;
