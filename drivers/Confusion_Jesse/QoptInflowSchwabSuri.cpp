...
int main(int argc, char *argv[])
{
  ...
  else   // do Schwab/Suri 2-element mesh
  {
    ...
    if (expectCrossBoundaryLayers)
    {
      ...
      el1.push_back(D_index);
      el2.push_back(B_index);
      el2.push_back(C_index);
      el2.push_back(F_index);
      el2.push_back(E_index);
      el3.push_back(D_index);
      el3.push_back(E_index);
      el3.push_back(H_index);
      el3.push_back(G_index);
      el4.push_back(E_index);
      el4.push_back(F_index);
      el4.push_back(I_index);
      el4.push_back(H_index);
      el5.push_back(G_index);
      el5.push_back(H_index);
      el5.push_back(K_index);
      el5.push_back(J_index);
      el6.push_back(H_index);
      el6.push_back(I_index);
      el6.push_back(L_index);
      el6.push_back(K_index);
