...
TEST_F(BasisCacheTests, TestSetRefCellPoints)
{
  double tol = 1e-14;
  ...
  for (int sideIndex=0; sideIndex < numSides; sideIndex++)
  {
    ...
    double maxDiff = 0;
    EXPECT_TRUE(fcsAgree(physicalCubaturePointsActual, physicalCubaturePointsExpected, tol, maxDiff))
      << "After resetting refCellPoints, physical cubature points are different in side basis cache.";
